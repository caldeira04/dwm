...
static const char *fonts[] = {"MonaspiceNe Nerd Font:size=12:style=Bold"};
static const char dmenufont[] = "MonaspaceNe Nerd Font:size=12:style=Bold";
...
static const char *mpcmenu[] = {"mpcmenu", NULL};
static const char *mpcplaylist[] = {"mpcmenu", "-p", NULL};
...
static const Key keys[] = {
    ...
    {ControlMask | ShiftMask, XK_p, spawn, {.v = mpcmenu}},
    {MODKEY | ShiftMask, XK_p, spawn, {.v = mpcplaylist}},
